...
public class Fragmentpage extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rl =  inflater.inflate(R.layout.result_page, container, false);
        return rl;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        lv = (ListView)getActivity().findViewById(R.id.result_page) ;
        previous =(Button) getActivity().findViewById(R.id.pageprev);
        nex = (Button) getActivity().findViewById(R.id.pagenext);
        GetItem();
    ...
    public void GetItem() {
        ...
        urlBuilder.addQueryParameter("type", "page");
                                ...
                                try {
                                    ...
                                    if (res != null) {
                                        try {
                                            ...
                                            mAdapter = new MyAdapter(array, result.mcontext, "page");
                                            lv.setAdapter(mAdapter);
