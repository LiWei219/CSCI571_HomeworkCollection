...
public class Fragmentgroup extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        previous =(Button) getActivity().findViewById(R.id.groupprev);
        nex = (Button) getActivity().findViewById(R.id.groupnext);
        GetItem();
    ...
    public void GetItem() {
        ...
        urlBuilder.addQueryParameter("type", "group");
                                ...
                                try {
                                    ...
                                    if (res != null) {
                                        try {
                                            ...
                                            mAdapter = new MyAdapter(array, result.mcontext, "group");
                                            lv.setAdapter(mAdapter);
