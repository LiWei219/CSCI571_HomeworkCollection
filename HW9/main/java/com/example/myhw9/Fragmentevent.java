...
public class Fragmentevent extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        rl =  inflater.inflate(R.layout.result_event, container, false);
        return rl;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        lv = (ListView)getActivity().findViewById(R.id.result_event) ;
        previous =(Button) getActivity().findViewById(R.id.eventprev);
        nex = (Button) getActivity().findViewById(R.id.eventnext);
        GetItem();
    ...
    public void GetItem() {
        ...
        urlBuilder.addQueryParameter("type", "event");
